        ...
        <div class="dashboard-box">
            <div class="dashboard">
                ...
                <div class="dashboard-form">
                    <h6 class="sub-dash" style="font-weight: 600;">Dashboard / <span style="font-weight: 100;">Admin</span></h6>
                                ...
                                <table id="adminTable">
                                    <thead>
                                        <?php
                                            ...
                                            $stmt = $conn->prepare("SELECT AccType FROM account WHERE AccountID = ?");
                                            ...
                                            // Fetch the AccountType
                                            if ($row = $result->fetch_assoc()) {
                                                if($row['AccType'] == 'Super_Admin'){
                                                    echo'<tr>
                                                        <th colspan="5">Admin List</th>
                                                        <th style="text-align: center; font-size: 16px;">
                                                            <button type="button" data-toggle="modal" data-target="#addAccount" class="btn btn-primary" >Add Account</button>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6">
                                                ...
                                                echo "No account found with AccountID: " . $accountID;
                                            }
                                    ?>
                                    <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT admin.*, account.status AS Status 
                                        FROM admin 
                                        LEFT JOIN account ON admin.AccountID = account.AccountID";                                
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                if($accType == 'Super_Admin'){
                                                    if($row["Status"] == "0"){
                                                        echo '<td><button class="btn btn-success" data-AdminID="' . $row["AdminID"] . '" onclick="setAdminID(this)" data-toggle="modal" data-target="#enable">Enable</button></td>';
                                                    }else{
                                                        echo '<td><button class="btn btn-danger" data-adminID="' . $row["AdminID"] . '" onclick="setAdminId(this)" data-toggle="modal" data-target="#disable">Disable</button></td>';
                                                    }
                                                }
                ...
                <div class="modal-body">
                    <form action="../process/add_admin.php" method="post">
                        <div class="form-groupp">
                            <label style="width: 30% !important;" for="username">Username:</label>
                            <input name="uname" type="text" placeholder="enter username">
                        </div>
                        <div class="form-groupp">
                            <label style="width: 30% !important;" for="password">Password:</label>
