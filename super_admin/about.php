...
<body>
                    ...
                    <div class="row" style="margin: 0 !important;">
                        ...
                        <?php
                            ...
                            if (!empty($aboutText)) {
                                ...
                                <p id='aboutt' style='display:none;'><textarea style='width: -webkit-fill-available' name='about' class='inp' type='text' disabled></textarea></p>
                                </div>
                                ";
                            }
    ...
    <?php
       ...
       function toggleEditSave() {
            ...
            var textareas = document.querySelectorAll('.inp');

            var aboutLink = document.getElementById('about-link');
            var about = document.getElementById('about');

            var abouttLink = document.getElementById('aboutt-link');
            ...
            if (button.innerText === 'Edit') {
                ...
                if (abouttLink) abouttLink.style.display = 'none';
                if (aboutt) aboutt.style.display = 'block';
