                ...
                if (isset($_GET['id'])) {
                    ...
                    if ($properties) {
                        foreach ($properties as $property) {
                            ...
                            echo '<p style="margin-top:50px;">You can contact me through <br> Contact #: '.$property['ContNum'].'<br> Social Media: <a href="'.$property['fblink'].'" target="_blank">Facbook Profile</a></p><br>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
